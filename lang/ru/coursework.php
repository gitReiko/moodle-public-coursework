...
// overview quota
$string['quota_overview'] = 'Обзор квоты';
...
$string['leader_replacement'] = 'Заменить руководителя';
...
$string['set_default_task_template'] = 'Установить шаблон задания по умолчанию';
...
$string['confirm_theme_reselect'] = 'Вы уверены, что хотите удалить выбор тем студентов? \nДанное действие нельзя отменить. После удаления выбора тем, студентам нужно будет снова выбрать тему.';