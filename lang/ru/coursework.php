...
$string['contact_the_teachers'] = 'Обратитесь к преподавателю для решения проблемы.';
...
$string['coursework:manage_global_old_files_area'] = 'Управлять старой областью файлов всех преподавателей';
$string['coursework:manage_own_old_files_area'] = 'Управлять собственной старой областью файлов преподавателя';
...
$string['e:quota_is_over'] = 'Ошибка: закончились доступные руководители. Свяжитесь с администратором курса для увеличения квоты руководителей.';
