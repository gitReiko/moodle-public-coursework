...
$string['add_suggested_themes_collection'] = 'Добавление предлагаемой коллекции тем';
$string['add_suggested_themes'] = 'Добавить предлагаемые темы';
$string['add_task_header'] = 'Добавление нового шаблона задания';
...
$string['adding_leader_appoint'] = 'Добавление руководителя позволит студентам выбрать руководителя, также вы сможеет распределить к нему студентов.';
...
$string['all_participants'] = 'Все участники';
$string['all_teachers'] = 'Все учителя';
$string['all'] = 'Все';
$string['answer_not_require'] = '<p>*Это сообщение отправлено автоматически и не требует ответа.</p>';
$string['appoint_explanation'] = 'Для того чтобы учитель мог работать с курсовой работой его нужно определить руководителем. По умолчанию студенты самостоятельно выбирают себе руководителя. Есть возможность распределения студентов к руководителям.';
$string['appoint_leaders'] = 'Определить руководителей и их квоты';
$string['appointed_leaders_not_exists'] = 'Руководители курсовой работы не определены.';
$string['assign_default_task'] = 'Выдать стандартное задание';
$string['automatic_task_obtaining'] = 'Автоматически выдавать задание на основе шаблона по умолчанию';
...
$string['back'] = 'Назад';
$string['by_course'] = 'По курсу';
$string['cancel_choice'] = 'Отменить выбор';
$string['cancel_theme_select'] = 'Отменить выбор темы';
$string['change_leader_for_selected_students'] = 'Изменить руководителя выбранным студентам';
$string['change_leader_for_students_header'] = 'Изменить руководителя следующим студентам:';
$string['change_my_files'] = 'Изменить мои файлы';
$string['change_suggested_themes_collection'] = 'Изменить предлагаемую коллекцию тем';
...
$string['contact_the_teachers'] = 'Обратитесь к учителю для решения проблемы.';
$string['correct_default_task'] = 'Скорректировать задание по умолчанию';
...
$string['coursework_is_ready'] = 'Курсовая работа готова.';
$string['coursework_is_sent_for_check'] = 'Курсовая работа отправлена на проверку.';
...
$string['coursework:deletestudentcoursework'] = 'Удалить курсовую работу студента';
$string['coursework:distributetoleaders'] = 'Распределить студента к руководителю';
$string['coursework:givetask'] = 'Выдать задание студенту';
$string['coursework:gradestudent'] = 'Оценить работу студента'; 
...
$string['coursework:leaderreplacement'] = 'Заменить руководителя';
$string['coursework:manage_global_old_files_area'] = 'Управлять старой областью файлов всех руководителей';
$string['coursework:manage_own_old_files_area'] = 'Управлять собственной старой областью файлов руководителя';
...
$string['coursework:returntothemeselection'] = 'Возвратить работу студента к этапу выбора темы';
$string['coursework:selecttheme'] = 'Выбрать тему курсовой работы';
$string['coursework:sendsectionforcheck'] = 'Отправить раздел задания на проверку';
$string['coursework:setdefaulttasktemplate'] = 'Установить шаблона задания по умолчанию';
$string['coursework:setsuggestedthemes'] = 'Установить предлагаемые темы';
$string['coursework:settingleaders'] = 'Определить руководителей';
$string['coursework:taskassignment'] = 'Выдать задание студенту';
$string['coursework:taskstemplatesmanagement'] = 'Управлять шаблонами заданий';
$string['coursework:themescollectionsmanagement'] = 'Управлять коллекцией тем';
$string['coursework:view'] = 'Просмотреть курсовую работу';
...
$string['distribute_students_selection'] = 'Распределить можно только, не выбравших себе руководителя, студентов.';
...
$string['e:quota_is_over'] = 'Ошибка: закончились доступные руководители. Свяжитесь с учителем, чтобы увеличить квоту руководителя.';
$string['e:student_didnt_choose_theme'] = 'Ошибка: студент не выбрал тему.';
$string['e:teacher_quota_over'] = 'Ошибка: квота руководителя на выбранный курс исчерана.';
...
$string['files_cant_be_modified'] = 'Файлы нельзя изменить.';
$string['firstname'] = 'Имя';
$string['for_course'] = 'Для курса';
$string['fullname'] = 'ФИО';
$string['give_task'] = 'Выдать задание';
$string['give_them_a_task'] = 'Выдайте студенту задание, чтобы он(а) смог(ла) продолжить работу.';
$string['go_to_collections_setup_page'] = 'Перейти на страницу настройки коллекций тем';
...
$string['go_to_leaders_appointment'] = 'Перейти к определению руководителей.';
...
$string['last_state_change'] = 'Посл. изм. статуса';
$string['lastname'] = 'Фамилия';
$string['lc_overview_header'] = 'Выберите студентов, которым нужно изменить руководителя';
$string['leader_changed_for_student'] = 'Изменён руководитель курсовой работы.';
$string['leader_course_explanation'] = 'Данная настройка позволяет одному пользователю проводить курсовую работу одновременно по нескольким курсам.';
$string['leader_explanation'] = 'Руководитель - это учитель, который руководит работой студентов.';
...
$string['leaders_appointment'] = 'Определение руководителей';
$string['leaders_not_exists'] = 'В курс не записаны пользователи с ролью учитель или ассистент.';
...
$string['managing_collection_themes'] = 'Управление темами коллекции';
$string['mass_selection_explanation'] = 'Для массового выбора сначала нажмите по списку, затем выберите нужную опцию.';
$string['mass_selection'] = 'Массовый выбор';
$string['mass_unselection_explanation'] = 'Нажмите по кнопке, чтобы отменить весь сделанный выбор.';
$string['max_files_number_help'] = 'Определяет максимальное количество файлов, которые пользователь может прикрепить к работе.';
$string['max_files_number'] = 'Макс. число файлов';
$string['max_files_size_help'] = 'Определяет максимальный размер файла, который можно прикрепить к курсовой работе.';
...
$string['names_filter_title'] = 'В списке отображаются только существующие первые буквы имён.';
...
$string['only_appointed_courses'] = 'В списке представлены только курсы, определённые руководителям.';
$string['only_appointed_leaders'] = 'В списке представлены только определённые руководители.';
...
$string['position_in_task_list'] = 'Порядок в списке разделов';
$string['proposed_themes'] = 'Предлагаемые темы';
$string['quota_exceeded'] = 'Количество студентов превышает квоту руководителя.';
$string['quota_explanation'] = 'Квота определяет количество студентов, которые могут выбрать учителя в качестве руководителя.';
...
$string['quota'] = 'Квота';
$string['ready_to_sent_for_check'] = 'Я прикрепил(а) все необходимые файлы и готов(а) отправить курсовую работу на проверку.';
...
$string['same_theme_can_be_selected_times'] = 'Определяет возможность выбора одной и той же темы несколько раз';
...
$string['select_student_to_activate_btn'] = 'Чтобы активировать кнопку, выберите хотя бы 1-го студента.';
...
$string['student_didnt_get_his_task'] = 'Студент не получил своё задание (не начал работу).';
$string['student_didnt_select_theme'] = 'Студент не выбрал тему (не начал работу).';
$string['student_didnt_start_work_no_data'] = 'Студент не начал работу (нет никаких данных).';
...
$string['task_assignment_header'] = 'Руководитель выдал Вам задание курсовой работы';
...
$string['task_template_not_using'] = 'В данный момент шаблон задания по умолчанию не используется.';
...
$string['teacher_accepted_and_graded_coursework'] = 'Руководитель принял и оценил курсовую работу';
$string['teacher_accepted_section'] = 'Руководитель принял раздел задания';
$string['teacher_assign_new_task_to_student'] = 'Руководитель выдал новое задание студенту';
$string['teacher_files'] = 'Файлы руководителя';
...
$string['teacher_regraded_coursework'] = 'Руководитель переоценил курсовую работу';
$string['teacher_sent_coursework_for_rework'] = 'Руководитель отправил курсовую работу на доработку';
$string['teacher_sent_section_for_rework'] = 'Руководитель отправил раздел задания на доработку';
$string['teacher_upload_file_header'] = 'Руководитель загрузил файл(ы) в курсовую работу';
$string['teacher_work_check_header'] = 'Студент отправил работу на проверку. Решите, что с ней делать.';
$string['teacher'] = 'Преподаватель';
$string['teachers_not_configured'] = 'Руководители курсовой работы не определены.';
...
$string['to_change_files_work_must_be_returned_for_rework'] = 'Для изменения файлов курсовую работу нужно вернуть на доработку.';
