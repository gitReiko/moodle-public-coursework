...
class Overview
{
    ...
    private function get_edit_button(\stdClass $section) : string 
    {
        ...
        $button.= '<input type="hidden"'.Main::ID.'" value="'.$this->cm->id.'" >';
        $button.= '<input type="hidden" name="'.Main::GUI_TYPE.'" value="'.Main::EDIT_SECTION.'">';
        $button.= '<input type="hidden" name="'.Main::TASK_ID.'" value="'.$this->task->id.'">';
        $button.= '<input type="hidden" name="'.Main::SECTION_ID.'" value="'.$section->id.'">';
        $button.= '</form>';
        return $button;
    }
    ...
    private function get_add_task_section_button() : string 
    {
        ...
        $button.= '<input type="hidden" name="'.Main::GUI_TYPE.'" value="'.Main::ADD_SECTION.'">';
        $button.= '<input type="hidden" name="'.Main::TASK_ID.'" value="'.$this->task->id.'">';
        $button.= '</form>';
        return $button;
    }
