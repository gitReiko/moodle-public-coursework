...
/**
 * @todo создать общего родителя для LeaderChangeAction и DistributeStudents
 */
class LeaderChangeAction 
{
    const FORM_NAME = 'change_leader';
    ...
    private function get_html_form() : string 
    {
        ...
        $form.= '<input type="hidden" name="'.ConfigurationManager::DATABASE_EVENT.'" value="'.LeaderChange::OVERVIEW.'"/>';
        $form.= '</form>';
