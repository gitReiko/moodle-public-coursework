...
/**
 * The student_chose_theme event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Student choose theme of his coursework.
 * }
 *
...
class student_chose_theme extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('student_chose_theme', 'coursework');
    }
 
    public function get_description() 
    {
        return "The student with id '$this->userid' chose theme of coursework.";
    }
