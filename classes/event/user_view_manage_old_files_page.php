...
/**
 * The user_view_manage_old_files_page event.
 *
...
/**
 * The user_view_manage_old_files_page event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      User viewed manage old files page.
 * }
 *
...
class user_view_manage_old_files_page extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('user_view_manage_old_files_page', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' views manage old files area page.";
    }
