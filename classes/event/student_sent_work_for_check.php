...
/**
 * The student_sent_work_for_check event.
 *
...
/**
 * The student_sent_work_for_check event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Student sent his coursework for check.
 * }
 * 
...
class student_sent_work_for_check extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('student_sent_work_for_check', 'coursework');
    }
 
    public function get_description() 
    {
        return "The student with id '$this->userid' sent coursework for check.";
    }
