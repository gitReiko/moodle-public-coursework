...
/**
 * The default_task_assigned_to_student event.
 *
...
/**
 * The default_task_assigned_to_student event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Default task assigned to student.
 * }
 *
...
class default_task_assigned_to_student extends \core\event\base {
    ...
    {
        return "The user with id '$this->userid' assign default task to student with id '$this->relateduserid'.";
    }
