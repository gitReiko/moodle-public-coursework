...
/**
 * The teacher_assign_new_task_to_student event.
 *
...
/**
 * The teacher_assign_new_task_to_student event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Teacher give new task to student.
 * }
 *
...
class teacher_assign_new_task_to_student extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('teacher_assign_new_task_to_student', 'coursework');
    }
 
    public function get_description() 
    {
        return "The teacher with id '$this->userid' assign new task to student with id '$this->relateduserid'.";
    }
