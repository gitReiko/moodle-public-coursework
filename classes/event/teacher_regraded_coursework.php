...
/**
 * The teacher_regraded_coursework event.
 *
...
/**
 * The teacher_regraded_coursework event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Teacher regrade student coursework.
 * }
 *
...
class teacher_regraded_coursework  extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('teacher_regraded_coursework', 'coursework');
    }
 
    public function get_description() 
    {
        return "The teacher with id '$this->userid' regraded coursework of student with id '$this->relateduserid'.";
    }
