...
class user_sent_message extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('user_sent_message', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' sent message to user with id '$this->relateduserid'.";
    }
