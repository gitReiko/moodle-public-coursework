...
/**
 * The leader_quota_increased event.
 *
...
/**
 * The leader_quota_increased event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Increased leader quota.
 * }
 *
...
class leader_quota_increased extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('leader_quota_increased', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' update quota of teacher with id '$this->relateduserid'.";
    }
