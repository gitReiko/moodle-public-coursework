...
/**
 * The coursework_leader_changed event.
 *
...
/**
 * The coursework_leader_changed event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Coursework leader changed.
 * }
 *
...
class coursework_leader_changed extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('coursework_leader_changed', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' changed coursework leader.";
    }
