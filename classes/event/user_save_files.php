...
/**
 * The user_save_files event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      User files in student coursework saved.
 * }
 *
...
class user_save_files  extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('user_save_files', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' save files in coursework of student with id '$this->relateduserid'.";
    }
