...
class themes_using_deleted extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('themes_using_deleted', 'coursework');
    }
 
    public function get_description() 
    {
        return "The user with id '$this->userid' using of themes collections is deleted.";
    }
