...
/**
 * The default_task_template_setted event.
 *
...
/**
 * The default_task_template_setted event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      Task setted as default for coursework.
 * }
 *
...
class default_task_template_setted extends \core\event\base {
    ...
    {
        return "The user with id '$this->userid' setted task template.";
    }
