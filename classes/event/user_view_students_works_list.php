...
/**
 * The user_view_students_works_list event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      User viewed students works list page.
 * }
 *
...
class user_view_students_works_list extends \core\event\base {
    ...
    public static function get_name() {
        ...
        return get_string('user_view_students_works_list', 'coursework');
    }
 
    public function get_description() 
    {
        return "The student with id '$this->userid' views students works list.";
    }
