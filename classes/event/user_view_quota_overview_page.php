...
/**
 * The user_view_quota_overview_page event.
 *
...
/**
 * The user_view_quota_overview_page event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      User viewed quotas overview page.
 * }
 *
...
class user_view_quota_overview_page extends \core\event\base {
    ...
    {
        return "The user with id '$this->userid' views quota overview page.";
    }
