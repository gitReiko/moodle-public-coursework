...
const CONFIG_MODULES = array(LEADERS_SETTING, THEME_COLLECTIONS_USING, THEMES_COLLECTIONS_MANAGEMENT, STUDENTS_DISTRIBUTION, REMOVE_DISTRIBUTION, LEADER_CHANGE);
