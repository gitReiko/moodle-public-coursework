...
$capabilities = array(
    ...
    'mod/coursework:is_manager' => array(
        'riskbitmask' => RISK_XSS,
    ...
    'mod/coursework:is_teacher' => array(
        'riskbitmask' => RISK_XSS,
    ...
    'mod/coursework:is_student' => array(
        'riskbitmask' => RISK_XSS,
    ...
    // Ability to view table with all participiants
    'mod/coursework:leaderreplacement' => array
    (
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
    ...
    'mod/coursework:themescollectionsmanagement' => array
    (
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
    ...
    'mod/coursework:taskstemplatesmanagement' => array
    (
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
